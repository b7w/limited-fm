...
from limited.core.serve.backends import BaseDownloadResponse
...
class DownloadManagerTest( StorageTestCase ):
    ...
    def setUp(self):
        ...
        settings.LIMITED_SERVE['BACKEND'] = 'limited.core.serve.backends.default'
    ...
    def test_backend(self):
        ...
        """
        settings.LIMITED_SERVE['BACKEND'] = 'limited.core.serve.backends.nginx'
