...
from limited.core.files.api.extra import FileStorageExtra
from limited.core.files.api.trash import FileStorageTrash
from limited.core.files.storage import FileError, FileNotExist

class FileStorageApi( FileStorageBaseApi ):
    """
    Height level api for :class:`~limited.core.files.storage.FileStorage`.
    ...
    :class:`limited.core.files.api.FileStorageExtra` objects
    """
